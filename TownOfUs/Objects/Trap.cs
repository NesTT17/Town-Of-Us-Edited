...
namespace TownOfUs.Objects {
    ...
    public static class TrapExtentions {
        ...
        public static Trap CreateTrap(this Vector3 location) {
            ...
            TrapPref.name = "Trap";
            TrapPref.transform.localScale = new Vector3(Trapper.trapSize * ShipStatus.Instance.MaxLightRadius * 2f, 
                Trapper.trapSize * ShipStatus.Instance.MaxLightRadius * 2f, Trapper.trapSize * ShipStatus.Instance.MaxLightRadius * 2f);
