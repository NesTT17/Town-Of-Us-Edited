...
namespace TownOfUs
{
    ...
    public class RoleInfo {
        ...
        public ObserveResults observeResults;

        public RoleInfo(string name, Color color, string introDescription, string shortDescription, RoleId roleId, FactionId factionId, ObserveResults observeResults) {
            this.name = name;
            this.color = color;
        ...
        public static RoleInfo sleuth = new RoleInfo("Sleuth", Color.yellow, "Learn the roles of bodies you report", "Learn the roles of bodies you report", RoleId.Sleuth, FactionId.Modifier, ObserveResults.None);
        public static RoleInfo tiebreaker = new RoleInfo("Tiebreaker", Color.yellow, "Your vote breaks the tie", "Break the tie", RoleId.Tiebreaker, FactionId.Modifier, ObserveResults.None);
        public static RoleInfo buttonBarry = new RoleInfo("Button Barry", Color.yellow, "Call meeting from anywhere", "Call meeting from anywhere", RoleId.ButtonBarry, FactionId.Modifier, ObserveResults.None);
        public static RoleInfo indomitable = new RoleInfo("Indomitable", Palette.CrewmateBlue, "Your role cannot be guessed", "Your role cannot be guessed", RoleId.Indomitable, FactionId.Modifier, ObserveResults.None);
        public static RoleInfo drunk = new RoleInfo("Drunk", Color.yellow, "Your movement is inverted", "Your movement is inverted", RoleId.Drunk, FactionId.Modifier, ObserveResults.None);
