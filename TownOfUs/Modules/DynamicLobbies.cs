...
namespace TownOfUs.Modules
{
    ...
    public static class DynamicLobbies
    {
        ...
        {
            public static void Prefix(InnerNet.InnerNetClient __instance, [HarmonyArgument(0)] NormalGameOptionsV09 settings)
            {
                int maxPlayers;
                try
                {
            ...
            public static void Postfix(InnerNet.InnerNetClient __instance, [HarmonyArgument(0)] NormalGameOptionsV09 settings)
            {
