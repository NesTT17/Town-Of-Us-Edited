...
namespace TownOfUs.Modules
{
    public class ModUpdater : MonoBehaviour {
        public const string RepositoryOwner = "NesTT17";
        public const string RepositoryName = "Town-Of-Us-Edited";
        ...
        private static bool FilterLatestRelease(GithubRelease release) {
            return release.IsNewer(TownOfUsPlugin.Version) && release.Assets.Any(FilterPluginAsset);
        }

        [HideFromIl2Cpp]
        private static bool FilterPluginAsset(GithubAsset asset) {
            return asset.Name == "TownOfUs.dll";
        }
        ...
        private void OnSceneLoaded(Scene scene, LoadSceneMode mode) {
            ...
            if (latestRelease == null || latestRelease.Version <= TownOfUsPlugin.Version)
                return;
        ...
        public IEnumerator CoShowAnnouncement(string announcement, bool show = true, string shortTitle = "TOU Update", string title = "", string date = "") {
            ...
            if (popUpTemplate == null) {
                TownOfUsPlugin.Logger.LogError("couldnt show credits, popUp is null");
                yield return null;
            }
