...
namespace TownOfUs.Modules
{
    public class CustomOption
    {
        ...
        public CustomOption(int id, CustomOptionType type, string name, System.Object[] selections, System.Object defaultValue, CustomOption parent, bool isHeader, Action onChange = null, string heading = "", bool invertedParent = false, string format = "")
        {
            ...
            if (id != 0)
            {
                ...
                {
                    TownOfUsPlugin.Instance.Log.LogWarning($"CustomOption id {id} is used in multiple places.");
                }
            }
            options.Add(this);
        }
    ...
    class LobbyViewSettingsPatch
    {
        ...
        public static void drawTab(LobbyViewSettingsPane __instance, CustomOptionType optionType)
        {
            ...
            if ((int)optionType == 99)
            {
                ...
                relevantOptions.AddRange(options.Where(x => x.type == CustomOptionType.NeutralEvil && x.isHeader));
    ...
    public class HudManagerUpdate {
        ...
        public static void Postfix(HudManager __instance) {
            ...
            bool zoomButtonActive = !(PlayerControl.LocalPlayer == null || !PlayerControl.LocalPlayer.Data.IsDead || ExileController.Instance || LobbyBehaviour.Instance || MeetingHud.Instance);
            toggleZoomButtonObject.SetActive(zoomButtonActive);
            var posOffset = Helpers.zoomOutStatus ? new Vector3(-1.27f, -7.92f, -52f) : new Vector3(0, -2.4f, -52f);
        ...
        public static void Postfix2(HudManager __instance) {
            ...
            if (!toggleSummaryButton || !toggleSummaryButtonObject) {
                ...
                renderer.sprite = Helpers.loadSpriteFromResources("TownOfUs.Resources.Endscreen.png", 100f);
                rendererActive.sprite = Helpers.loadSpriteFromResources("TownOfUs.Resources.EndscreenActive.png", 100f);
            ...
            toggleSummaryButtonObject.SetActive(__instance.SettingsButton.gameObject.active && LobbyBehaviour.Instance && !Helpers.previousEndGameSummary.IsNullOrWhiteSpace());
